...
*/
    ...
    obj.rotationSpeed = .0125 * Math.PI;
    obj.speed.x = 1;
    obj.inertia = 10000;
    scene.addObject(obj);
    ...
    obj.init(
        ...
        1e12,
        new Vector(0, -20),
        [new Vector(-100, 50), new Vector(-98, 50), new Vector(-98, 5), new Vector(98, 5), new Vector(98, 50), new Vector(100, 50), new Vector(100, -5), new Vector(-100, -5)]
    );
    obj.rotationSpeed = 0;
    obj.speed.x = 0;
    obj.speed.y = 0;
